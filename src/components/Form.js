...
const Form = ({handleButtonClick}) => {
  ...
  return (
    <div className="col-11 shadow" id="thirdBoxMain1">
      <p id="formMainHead1">Please Fill Your Birth Details Here:</p>
      <form
        id="calculatorId"
        action="/"
      ...
      >
        <div className="mb-2 col-md-6">
          <label for="urname" className="formlabelunwanted form-label">
            Enter your name
          </label>
          <input
            required="true"
        ...
        <div className="mb-2 col-md-6">
          <label className="formlabelunwanted form-label">
            Enter your email
          </label>
          <input
            required="true"
        ...
        <div className="mb-2 col-md-6">
          <label for="gender" className="formlabelunwanted form-label">
            Enter your gender
          </label>
          <br />
          <select
        ...
        <div className="mb-2 col-md-6">
          <label for="purpose" className="formlabelunwanted form-label">
        ...
        <div className="mb-2 col-md-6">
          <label for="dob" className="formlabelunwanted form-label">
        ...
        <div className="mb-2 col-md-6">
          <label for="tob" className="formlabelunwanted form-label">
